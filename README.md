...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-06 01:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f71b689d-7d7a-4f3e-b7c8-c23ac8dc725e.git
$ cd f71b689d-7d7a-4f3e-b7c8-c23ac8dc725e
```
